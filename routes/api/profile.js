...
// Add "auth" as a second parameter to any routes that you want to protect
...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      // When using a mongoose method put await in front of it because it returns a promise
      ...
      // Create a profile if there isn't one
...
// @description Get profile by the user ID
// @access      Public
